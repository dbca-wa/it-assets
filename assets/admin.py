...
class SupplierAdmin(AuditAdmin):
    ...
    search_fields = ('name', 'account_rep', 'contact_email', 'contact_phone', 'website', 'notes')
...
class AssetAdmin(AuditAdmin):
    list_display = ('asset_tag', 'get_type', 'get_model', 'serial', 'status', 'get_age', 'get_location', 'get_assigned_user')
    list_filter = ('model__manufacturer', 'status', 'location__site', 'date_purchased')
    search_fields = ('asset_tag', 'model__model', 'status', 'model__manufacturer__name', 'model__model_type', 'location__name', 'location__block', 'location__site', 'assigned_user', 'serial', 'invoice__supplier_ref', 'invoice__job_number', 'invoice__cost_centre_number', 'invoice__etj_number')
    form = AssetAdminForm
...
class InvoiceAdmin(AuditAdmin):
    list_display = ('job_number', 'supplier', 'supplier_ref', 'total_value', 'get_assets', 'notes')
    list_filter = ('supplier__name',)
    search_fields = ('supplier__name', 'supplier__account_rep', 'supplier__contact_email', 'supplier__contact_phone', 'supplier__notes', 'supplier_ref', 'job_number', 'total_value', 'notes')
    actions_on_top = False

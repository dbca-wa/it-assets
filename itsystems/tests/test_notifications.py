...
class NotificationsTestCase(TestCase):
    ...
    def test_user_deletion_email(self):
        ...
        """
        msg = send_user_deletion_email(system_name="example_system", field_name="example_field", field_value="example_value")
        self.assertIn("example_system",msg.body)
        self.assertIn("example_field",msg.body)
        self.assertIn("example_value",msg.body)
        self.assertIn("invalid_email",msg.to)
        self.assertIn("example_system",msg.subject)

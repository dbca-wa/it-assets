...
textarea_readonly_widget = ReadonlyWidget(lambda value: '<table><tr><td style="border: 1px solid gray"><pre>{}</pre></td></tr></table>'.format(value) if value else '<table style="width:80%;height:50px"><tr><td style="border: 1px solid gray"></td></tr></table>')

...
from rancher import models,modeldata
...
def tansform_other_config_to_json(apps,schema_editor):
    ...
    with connection.cursor() as cursor:
        ...
        if cursor.fetchone()[0] == 0:
            logger.debug("Column 'other_config_old' doesn't exist, already processed.")
            return

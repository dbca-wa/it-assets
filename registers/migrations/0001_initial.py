    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ah_support', models.ForeignKey(blank=True, help_text='After-hours support contact', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ah_support', to='organisation.departmentuser', verbose_name='after hours support')),
                ('bh_support', models.ForeignKey(blank=True, help_text='Business hours support contact', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bh_support', to='organisation.departmentuser', verbose_name='business hours support')),
                ('cost_centre', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='organisation.costcentre')),
                ('information_custodian', models.ForeignKey(blank=True, help_text='Information custodian', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='systems_info_custodianed', to='organisation.departmentuser')),
                ('owner', models.ForeignKey(blank=True, help_text='IT system owner', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='systems_owned', to='organisation.departmentuser', verbose_name='system owner')),
                ('technology_custodian', models.ForeignKey(blank=True, help_text='Technology custodian', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='systems_tech_custodianed', to='organisation.departmentuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endorser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='organisation.departmentuser')),
        ...
        migrations.AddField(
            model_name='itsystem',
            name='user_groups',
            field=models.ManyToManyField(blank=True, help_text='User group(s) that use this system', to='registers.ITSystemUserGroup'),
        ),
        migrations.CreateModel(
            name='ChangeRequest',
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'Draft'), (1, 'Submitted for endorsement'), (7, 'Ready for SME review'), (2, 'Scheduled for CAB'), (3, 'Ready for implementation'), (4, 'Complete'), (5, 'Rolled back'), (6, 'Cancelled')], db_index=True, default=0)),
                ...
                ('endorser', models.ForeignKey(blank=True, help_text='The person who will endorse this change prior to CAB', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='endorser', to='organisation.departmentuser')),
                ('implementer', models.ForeignKey(blank=True, help_text='The person who will implement this change', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='implementer', to='organisation.departmentuser')),
                ...
                ('requester', models.ForeignKey(blank=True, help_text='The person who is requesting this change', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='requester', to='organisation.departmentuser')),
                ('sme', models.ForeignKey(blank=True, help_text='Optional subject matter expert for this change', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sme', to='organisation.departmentuser', verbose_name='subject matter expert')),
                ('standard_change', models.ForeignKey(blank=True, help_text='Standard change reference (if applicable)', null=True, on_delete=django.db.models.deletion.SET_NULL, to='registers.standardchange')),
            ],
            options={
